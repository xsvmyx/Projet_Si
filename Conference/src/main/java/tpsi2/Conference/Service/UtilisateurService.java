...
public class UtilisateurService {
    ...
    public Utilisateur getUserFromContextBis(){
        UserPrincipal user =(UserPrincipal) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
        Utilisateur utilisateur = userRepository.findById(user.getUserId()).get();
        return utilisateur;
    }
    ...
    public ResponseEntity<?> assignEditeurToConference(String username,String role,Long conferenceId,Long soumissionId){
        Utilisateur utilisateur = userRepository.findByUsername(username);
        ...
        if(utilisateur != null){
            ...
            //ajouter la soumission au set d'evaluateur
