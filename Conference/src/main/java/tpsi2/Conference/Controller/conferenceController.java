...
public class conferenceController {
 ...
 public ResponseEntity<?> openConference(@PathVariable Long conferenceId) {
    ...
    @PutMapping ("/{conferenceId}/evaluer")
    @PreAuthorize("@utilisateurService.hasRoleInConference(#conferenceId,'EDITEUR')")
    public ResponseEntity<?> closeSubConference(@PathVariable Long conferenceId) {

        return ResponseEntity.ok(conferenceService.mettreEnEvaluationConference(conferenceId));
    }
